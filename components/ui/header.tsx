      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="shrink-0 mr-4">
            {/* Logo */}
            <Link className="block group" href="/" aria-label="MIGRATE">
          ...
          <nav className="flex grow">
            ...
            <ul className="flex grow justify-end flex-wrap items-center gap-x-2">
              <li className="ml-6">
                <Link
              ...
              {/* Language switcher */}
              <li className="ml-4 flex items-center gap-x-1">
                {(['es', 'en', 'fr'] as Locale[]).map((lang) => (
                  <button
                    key={lang}
                    onClick={() => setLocale(lang)}
                    className={`text-xs font-bold px-2 py-1 rounded transition duration-150 ease-in-out ${
                      locale === lang
