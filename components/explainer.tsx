      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h2 className="h2 font-cabinet-grotesk">Personas de toda Latinoamérica ya están dando el paso.</h2>
          </div>
          ...
          {/* Callout previo al CTA */}
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h3 className="h2 font-cabinet-grotesk mb-4">¿Quieres venir ya?</h3>
            <p className="text-gray-600">
              Te ayudamos a obtener tu estancia de estudios y trabajo.
            </p>
            <div className="mt-6">
