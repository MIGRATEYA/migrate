...
import VideoThumb from '@/public/images/explainer.png'
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h2 className="h2 font-cabinet-grotesk">{e.heading}</h2>
          </div>
          ...
          <div className="relative pb-12">
            ...
            <div className="max-w-sm mx-auto grid gap-12 sm:grid-cols-2 sm:max-w-3xl lg:grid-cols-4 lg:max-w-none items-start">
              ...
              <div className="text-center">
                ...
                <h3 className="font-cabinet-grotesk font-bold text-lg">{e.step1Title}</h3>
                <div className="text-gray-500">{e.step1Desc}</div>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="font-cabinet-grotesk font-bold text-lg">{e.step2Title}</h3>
                <div className="text-gray-500">{e.step2Desc}</div>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="font-cabinet-grotesk font-bold text-lg">{e.step3Title}</h3>
                <div className="text-gray-500">{e.step3Desc}</div>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="font-cabinet-grotesk font-bold text-lg">{e.step4Title}</h3>
                <div className="text-gray-500">{e.step4Desc}</div>
              </div>
            </div>
          </div>
          ...
          {/* Callout */}
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h3 className="h2 font-cabinet-grotesk mb-4">{e.ctaTitle}</h3>
            <p className="text-gray-600">{e.ctaDesc}</p>
            <div className="mt-6">
              <Link className="btn inline-flex items-center text-white bg-gray-900 hover:bg-gray-800 group" href="/estudios">
                {e.ctaBtn}
