      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl pb-12 md:pb-16">
            <h2 className="h2 font-cabinet-grotesk text-white">Te ayudamos a elegir programas de cursos, diplomados, másteres o FP </h2>
          </div>
          ...
          <div className="max-w-sm mx-auto grid sm:grid-cols-2 sm:max-w-3xl lg:grid-cols-4 lg:max-w-none items-start">
            ...
            >
              ...
              <h3 className="font-cabinet-grotesk font-bold text-lg text-white">Cambio a estancia o residencia</h3>
              <div className="text-white text-opacity-80">Si entraste como turista o con otro tipo de estancia, estudiamos si puedes cambiar a estancia por estudios, residencia por trabajo u otra figura legal según tu caso.</div>
            </div>
            ...
            >
              ...
              <h3 className="font-cabinet-grotesk font-bold text-lg text-white">Arraigos y regularización</h3>
              <div className="text-white text-opacity-80">Te asesoramos en arraigo social, laboral, familiar o por formación, revisando tiempos de residencia, contratos, vínculos y pruebas que necesitas presentar.</div>
            </div>
            ...
            >
              ...
              <h3 className="font-cabinet-grotesk font-bold text-lg text-white">Trámites avanzados y recursos</h3>
              <div className="text-white text-opacity-80">En casos de denegaciones, expedientes complicados o recursos administrativos, te acompañamos para presentar la documentación correcta y defender tus derechos.</div>
            </div>
            ...
            >
              ...
              <h3 className="font-cabinet-grotesk font-bold text-lg text-white">Red de apoyo en España</h3>
              <div className="text-white text-opacity-80">Aprovecha nuestra red de contactos: instituciones educativas, asesores legales y servicios clave en España. Te ayudamos a abrir puertas y tomar decisiones con información real, no solo con teoría.</div>
            </div>
          </div>
        </div>
      </div>
