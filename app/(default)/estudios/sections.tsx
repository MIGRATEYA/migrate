...
export default function EstudiosSections() {
  const { t } = useLanguage()
  const e = t.estudiosPage
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="pt-20 pb-16 md:pt-24 md:pb-20">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="h2 font-cabinet-grotesk text-white mb-3">{e.networkHeading}</h2>
              <p className="text-lg md:text-xl text-white text-opacity-80">{e.networkDesc}</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section>
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="py-12 md:py-16 text-center">
            <h3 className="h3 font-cabinet-grotesk mb-3">{e.ctaTitle}</h3>
            <p className="text-gray-500 mb-6">{e.ctaDesc}</p>
            <Link
